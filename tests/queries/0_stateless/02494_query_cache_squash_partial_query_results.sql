...
-- Create test table with four rows
...
-- Run query which reads multiple chunks (small max_block_size), cache result in query cache
SELECT * FROM t ORDER BY c SETTINGS max_block_size = 2, use_query_cache = true, query_cache_squash_partial_query_results = true;
